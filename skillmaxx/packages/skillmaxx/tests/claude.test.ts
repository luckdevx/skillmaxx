...
describe("cleanupClaudeMd", () => {
  ...
  it("returns cleaned=false when CLAUDE.md has no skillmaxx markers", () => {
  ...
  it("deletes CLAUDE.md when only the skillmaxx section remains", () => {
    writeFileSync(
  ...
  it("removes skillmaxx section but preserves user content", () => {
    const content =
      "# CLAUDE.md\n\nMy custom instructions.\n\n<!-- skillmaxx:start -->\n\nGenerated content.\n\n<!-- skillmaxx:end -->\n\n## My notes\n\nDo not touch this.\n";
    ...
    ok(!output.includes("<!-- skillmaxx:start -->"));
