...
export const SKILLS_MAP: Technology[] = [
  ...
  },
  {
    ...
    name: "Docker",
    detect: {
      configFiles: ["Dockerfile", "docker-compose.yml", "docker-compose.yaml", "compose.yaml"],
    },
    skills: [
      "KentoShimizu/sw-agent-skills/dockerfile-best-practices",
      "KentoShimizu/sw-agent-skills/docker-compose-patterns",
    ],
  },
  {
    id: "github-actions",
    ...
    skills: [
      "KentoShimizu/sw-agent-skills/github-actions-workflow-design",
      "KentoShimizu/sw-agent-skills/github-fix-ci",
    ],
  },
];
