...
2. Comprueba el formato:
   `pnpm fmt:check`
3. Compila `packages/skillmaxx`:
   `pnpm --dir packages/skillmaxx build`
4. Ejecuta todos los tests de `packages/skillmaxx`:
   `pnpm --dir packages/skillmaxx test`
5. Valida el registry de skills:
   `pnpm --dir packages/skillmaxx validate:registry`
